...
<template>
  <div class="flex">
    <div
      class="relative z-100 flex flex-space-between border-4 border-gray-950 border-b-0 w-32 h-32 text-6xl"
    ...
    <button
      class="bg-gray-400 m-2 my-auto p-2 h-12"
      @click="callHandlerEmit"
      :class="isCallButtonBorder"
    >
      Call
    </button>
